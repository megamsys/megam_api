...
module Megam
  ...
  class ServerAPI
    ...
    def initialize(email=nil, api_key=nil, host=nil, password=nil)
      @email = email
      @api_key = api_key
      @host = host
      @password = password
    ...
    def megam_rest
      options = { :email => email || Megam::Config[:email], :api_key => api_key || Megam::Config[:api_key], :password => password || Megam::Config[:password], :host => host || Megam::Config[:host]}
